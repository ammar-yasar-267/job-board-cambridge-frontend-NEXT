...
const NewsLetterSubscription = ({ email, setEmail, handleSubscribe }) => {
  return (
    <div className="max-w-4xl mx-auto bg-gradient-to-br from-green-700 to-green-600 shadow-lg rounded-lg p-6 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <p className="text-green-100 mb-4 flex items-center">
        ...
        <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
          <div className="flex-grow relative">
            <input
              ...
              className="w-full p-3 pl-10 rounded-lg border border-green-400 bg-green-50 focus:outline-none focus:ring-2 focus:ring-green-300 transition duration-150 ease-in-out"
              value={email}
          ...
          <button 
            type="submit"
            className="bg-green-500 hover:bg-green-400 text-white px-6 py-3 rounded-lg transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-green-300 focus:ring-offset-2 flex items-center justify-center"
          >
            <span>Subscribe</span>
